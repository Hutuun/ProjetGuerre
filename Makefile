CXX=g++
CXXFLAGS=-Wall -Wextra -std=c++17 -pthread -ISFML/include -Iinclude -Wall -std=c++1z -fexceptions -g -Isrc  -Isrc/Terrain -LSFML/sfml-graphics -LSFML/sfml-window -LSFML/sfml-system -LSFML/sfml-audio
LDFLAGS = -lfl
EXEC = ProjetGuerre
